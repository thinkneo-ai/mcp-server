...
from .billing_status import register as register_billing_status
from .billing_upgrade import register as register_billing_upgrade
from .billing_cancel import register as register_billing_cancel
...
def register_all(mcp) -> None:
    ...
    register_billing_subscribe(mcp)
    register_billing_status(mcp)
    register_billing_upgrade(mcp)
    register_billing_cancel(mcp)
